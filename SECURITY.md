...
The CodeMode execution boundary and deployment requirements are documented in [docs/docs/security.md](docs/docs/security.md). Non-security bugs belong in GitHub issues as described in [CONTRIBUTING.md](CONTRIBUTING.md).
